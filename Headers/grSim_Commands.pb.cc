...
void protobuf_AssignDesc_grSim_5fCommands_2eproto() {
  ...
  static const int grSim_Robot_Command_offsets_[15] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(grSim_Robot_Command, kickmode_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(grSim_Robot_Command, disarmkicker_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(grSim_Robot_Command, spinnerspeed_),
  };
...
void protobuf_AddDesc_grSim_5fCommands_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024grSim_Commands.proto\"\250\002\n\023grSim_Robot_C"
    ...
    "\001(\002\022\016\n\006wheel4\030\014 \001(\002\022\020\n\010kickmode\030\r \001(\005\022\024\n"
    "\014disarmKicker\030\016 \001(\010\022\024\n\014spinnerspeed\030\017 \001("
    "\002\"g\n\016grSim_Commands\022\021\n\ttimestamp\030\001 \002(\001\022\024"
    "\n\014isteamyellow\030\002 \002(\010\022,\n\016robot_commands\030\003"
    " \003(\0132\024.grSim_Robot_Command", 426);
...
const int grSim_Robot_Command::kKickmodeFieldNumber;
const int grSim_Robot_Command::kDisarmKickerFieldNumber;
const int grSim_Robot_Command::kSpinnerspeedFieldNumber;
#endif  // !_MSC_VER
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 255) {
    ZR_(id_, velangular_);
    ZR_(spinner_, wheelsspeed_);
  }
  if (_has_bits_[8 / 32] & 32512) {
    ZR_(disarmkicker_, spinnerspeed_);
    wheel1_ = 0;
  }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 12: {
        ...
        if (input->ExpectTag(104)) goto parse_kickmode;
        break;
      }
      ...
      case 13: {
        ...
        if (input->ExpectTag(112)) goto parse_disarmKicker;
        break;
      }
      ...
      case 14: {
        ...
        if (input->ExpectTag(125)) goto parse_spinnerspeed;
        break;
      }
...
void grSim_Robot_Command::SerializeWithCachedSizes(
  ...
  // optional int32 kickmode = 13;
  if (has_kickmode()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(13, this->kickmode(), output);
  }

  // optional bool disarmKicker = 14;
  if (has_disarmkicker()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(14, this->disarmkicker(), output);
  }

  // optional float spinnerspeed = 15;
  if (has_spinnerspeed()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(15, this->spinnerspeed(), output);
  }
...
::google::protobuf::uint8* grSim_Robot_Command::SerializeWithCachedSizesToArray(
  ...
  // optional int32 kickmode = 13;
  if (has_kickmode()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(13, this->kickmode(), target);
  }

  // optional bool disarmKicker = 14;
  if (has_disarmkicker()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(14, this->disarmkicker(), target);
  }

  // optional float spinnerspeed = 15;
  if (has_spinnerspeed()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(15, this->spinnerspeed(), target);
  }
...
void grSim_Robot_Command::MergeFrom(const grSim_Robot_Command& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (from.has_kickmode()) {
      set_kickmode(from.kickmode());
    }
    if (from.has_disarmkicker()) {
      set_disarmkicker(from.disarmkicker());
    }
    if (from.has_spinnerspeed()) {
      set_spinnerspeed(from.spinnerspeed());
    }
  }
...
void grSim_Robot_Command::Swap(grSim_Robot_Command* other) {
  if (other != this) {
    ...
    std::swap(kickmode_, other->kickmode_);
    std::swap(disarmkicker_, other->disarmkicker_);
    std::swap(spinnerspeed_, other->spinnerspeed_);
